...
exports.bookinstance_list = function(req, res, next) {
    ...
    .exec(function(err, list_bookinstances) {
        ...
        var sorted = [];
        for (const [key, value] of Object.entries(list_bookinstances)) {
            sorted.push(value);
        }
        sorted.sort(function(a, b) {let textA = a.book.title.toUpperCase(); let textB = b.book.title.toUpperCase(); return (textA < textB) ? -1 : (textA > textB) ? 1 : 0;});
        res.render("bookinstance_list", { title: "Book Instance List", bookinstance_list: sorted });
    });
};
...
exports.bookinstance_delete_post = function(req, res, next) {
    BookInstance.findByIdAndRemove(req.body.bookinstanceid, function deleteBookInstance(err) {
        if (err) { return next(err); }
        // Success - go to book instance list list
        res.redirect('/catalog/bookinstances');
    });
};
...
exports.bookinstance_update_get = function(req, res, next) {
    // Get books list and book instance detail
    async.parallel({
